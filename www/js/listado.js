...
function cortar_fecha(fecha){
    ...
    function get_autowikipedia_events(latitud,longitud) {
        ...
        var url = "http://autoplay.es/phonegap/racing_calendar_eventos_por_categoria.php?id_categoria=" + id_categoria;
            ...
            //contenido header
                 header.append('<img style="float: left;margin-left:20px;" class="anterior_se" src="images/back_w.png" height="40px" /><!-- <img style="float: right; margin-right:20px;" class="siguiente_se" src="images/next2_w.png" height="40px" />--><div class="texto23"><span class="ultra-bold" style="font-size:' + fuente_header + 'px;">category/</span><span class="light" style="font-size:' + fuente_header + 'px;">' + data[0].categoria + '</span></div>' );
            for (var i=0; i<data.length; i++) {
                ...
                if (data[i].circuito_id != "240") {
                    ...
                    var distancia = '<img src="images/location_b.png" height="15px">' + Math.ceil(p1.distanceTo(p2)) + " kms ";
                ...
                //contenido body
                eventos.append('<div class="listado" style="height:'+ altura_listado + 'px; "><div class="listado_izq" style="height:'+ altura_listado + 'px; "><span class="light" style="font-size:50px;">' + cortar_fecha(dia) + '</span><br><span class="light" style="font-size:20px;">' + monthNames[cortar_fecha(mes)] + '</span></div><div class="listado_der" style="height:'+ altura_listado + 'px; ">'+ destacado + '<div class="principal" style="font-size:' + fuente_principal + 'px;"><span class="ultra-bold">' + data[i].carrera + '</span></div><div class="info" style="font-size:' + fuente_info + 'px;"><span class="ultra-bold">' + monthNames[cortar_fecha(mes)] + '</span><span class="light">' + cortar_fecha(dia) + nro_fecha + '</span></div><div class="distancia" style="font-size:' + fuente_distancia + 'px;"> ' + distancia + '</div><div class="distancia distancia_final"> ' + circuito + '</div></div></div>');
            } //cierra for
        }, "json");
