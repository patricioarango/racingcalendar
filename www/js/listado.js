    ...
    function get_autowikipedia_events(latitud,longitud) {
        ...
        var url = "http://autoplay.es/phonegap/racing_calendar_eventos_por_categoria.php?id_categoria=" + id_categoria;
            ...
            for (var i=0; i<data.length; i++) {
                ...
                //contenido body
                eventos.append('<div class="listado" style="height:'+ altura_listado + 'px;margin-top:' + margin_listado + 'px;margin-top:' + margin_listado2 + 'px;"><div class="listado_izq" style="height:'+ ( (altura_listado / 2 ) + 23)+ 'px;margin-top:'+ ( (altura_listado / 2) - 23 ) +'px; "><span class="ultra-bold" style="font-size:' + fuente_mes + 'px;">' + monthNames[cortar_fecha(mes)] + '</span><span class="light" style="font-size:' + fuente_fecha + 'px;">' + cortar_fecha(dia) + '</span></div><div class="listado_der" style="height:'+ altura_listado + 'px; ">'+ destacado + '<div class="principal" style="font-size:' + fuente_principal + 'px;"><span class="ultra-bold">' + data[i].carrera + '</span></div><div class="info" style="font-size:' + fuente_info + 'px;">' + nro_fecha + '</span></div><div class="distancia" style="font-size:' + fuente_distancia + 'px;"> ' + distancia + '</div><div class="distancia distancia_final" style="font-size:' + fuente_circuito + 'px;"> ' + circuito + '</div></div></div>');
            } //cierra for
